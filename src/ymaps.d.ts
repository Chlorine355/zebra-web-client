...
declare namespace ymaps {
  ...
  namespace map {
    ...
    class Balloon implements IBalloonManager<Balloon> {
      /*, IBalloonSharingManager*/ constructor(map: Map);
  ...
  class GeoQueryResult implements IPromiseProvider {
    ...
    getClosestTo(
      object: IGeoObject | IGeometry | Map | number[] | object,
    ): IGeoObject | null;
    ...
    searchContaining(
      object: IGeoObject | IGeometry | Map | number[] | number[][] | object,
    ): GeoQueryResult;
    searchInside(object: IGeoObject | IGeometry | Map): GeoQueryResult;
    searchIntersect(
      object: IGeoObject | IGeometry | Map,
    ...
    sort(
      comparator: string | ((a: object, b: object) => number),
    ): GeoQueryResult;
    sortByDistance(
      object: IGeoObject | IGeometry | Map | number[] | number[][] | object,
    ): GeoQueryResult;
  ...
  function geoQuery(
    object: IGeoObject | IGeoObject[] | IGeoObject[] | ICollection[],
  ): GeoQueryResult;
